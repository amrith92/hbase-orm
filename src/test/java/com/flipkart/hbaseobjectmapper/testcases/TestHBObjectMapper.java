...
public class TestHBObjectMapper {
    ...
    private final List<Triple<HBRecord, String, Class<? extends IllegalArgumentException>>> invalidRecordsAndErrorMessages = Arrays.asList(
            ...
            triple(new ClassWithNoHBColumns(), String.format("Class with no fields mapped with %s", HBColumn.class.getSimpleName()), MissingHBColumnFieldsException.class),
            triple(new ClassWithHBColumnWithUnknownColumnFamily(), "Class with a field mapped to a column family that isn't specified in " + HBTable.class.getSimpleName() + " annotation", ColumnFamilyNotInHBTableException.class),
            ...
            triple(new ClassesWithInvalidHBTableAnnotation.InvalidVersions(), "Class with an invalid number of versions in its " + HBTable.class.getSimpleName() + " annotation", ImproperHBTableAnnotationExceptions.InvalidValueForVersionsOnHBTableAnnotationException.class),
            triple(new ClassesWithInvalidHBTableAnnotation.EmptyTableName(), "Class with empty table name in its " + HBTable.class.getSimpleName() + " annotation", ImproperHBTableAnnotationExceptions.EmptyTableNameOnHBTableAnnotationException.class),
            triple(new ClassesWithInvalidHBTableAnnotation.EmptyColumnFamily(), "Class with empty column family name in its " + HBTable.class.getSimpleName() + " annotation", ImproperHBTableAnnotationExceptions.EmptyColumnFamilyOnHBTableAnnotationException.class),
            triple(new ClassesWithInvalidHBTableAnnotation.DuplicateColumnFamilies(), "Class with duplicate column families in its " + HBTable.class.getSimpleName() + " annotation", ImproperHBTableAnnotationExceptions.DuplicateColumnFamilyNamesOnHBTableAnnotationException.class),
